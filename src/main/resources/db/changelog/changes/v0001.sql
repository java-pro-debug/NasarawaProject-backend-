...
CREATE TABLE individual_tin_generation (
                            id SERIAL PRIMARY KEY,
                            bvn character varying(100) ,
                            tin character varying(100),
                            response_description character varying(300),
...
CREATE TABLE non_individual_tin_generation (
                                id SERIAL PRIMARY KEY,
                                ...
                                tin_reg_date character varying(100),
